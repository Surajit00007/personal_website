                  ...
                  <CardContent className="p-6">
                    <div className="flex flex-col md:flex-row gap-6">
                      ...
                      <div className="flex-1 space-y-4">
                        ...
                        <div className="space-y-1">
                          <Label className="text-xs text-muted-foreground">LinkedIn / Credential URL</Label>
                          <div className="relative">
                            <ExternalLink className="absolute left-2 top-2.5 w-4 h-4 text-muted-foreground" />
                            <Input
                              value={cert.linkedinUrl || ''}
                              onChange={(e) => updateCertificate(cert.id, 'linkedinUrl', e.target.value)}
                              className="pl-8"
